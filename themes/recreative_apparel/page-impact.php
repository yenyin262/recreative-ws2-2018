...
?>
      ...
      <div id="custom-bg" class="top-banner" style="background-image: url('<?php echo $image[0]; ?>');"></div>
      <?php endif;?>
            ...
            <div class="impact-container">
              <?php
                  ...
                  <section class="grid-impact">
                    ...
                    <div class="blue-text heading grid-impact-number"><h3><?php echo $impact['impact_number']; ?></h3></div>
