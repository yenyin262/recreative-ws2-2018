<?php
 /**
 *
 * @package   Recreative Apparel Functionality
 * @author    Recreative Apparel Team
 * @license   GPL-2.0+
 * @copyright 2019 Recreative Apparel
 *
 * @wordpress-plugin
 * Plugin Name: Recreative Apparel Functionality
